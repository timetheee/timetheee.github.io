...
function configSigmaElements(config) {
    ...
    var a = [],
        b,x=1;
        domaine = lang[language].domaine; //fba
        a.push('<div style="line-height:12px"><a href="#' + b + '"><div style="width:20px;height:12px;border:1px solid #fff;background:' + b + ';display:inline-block"></div>' + domaine[x-1] + ' (' + sigInst.clusters[b].length + ' articles)</a></div>');
                    x++;    //a.sort();
